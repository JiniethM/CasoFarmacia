...
public class MDI_Farmacia11 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton_Producto.setFont(new java.awt.Font("Dialog", 1, 13)); // NOI18N
        jButton_Producto.setForeground(new java.awt.Color(255, 255, 255));
        jButton_Producto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Vistas_Iconos/frasco-de-pastillas.png"))); // NOI18N
        jButton_Producto.setText("Producto");
        jButton_Producto.setBorder(javax.swing.BorderFactory.createEtchedBorder(javax.swing.border.EtchedBorder.RAISED));
        jButton_Producto.setBorderPainted(false);
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(jButton_Producto, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton_Cliente(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_Cliente
        ...
        int x = (jDesktopPane_Para_Mostrar.getWidth() - est.getWidth()) / 2;
        int y = (jDesktopPane_Para_Mostrar.getHeight() - est.getHeight()) / 2;
        est.setLocation(x, y);
        est.mostrar();
        jDesktopPane_Para_Mostrar.add(est);
        est.setVisible(true);
